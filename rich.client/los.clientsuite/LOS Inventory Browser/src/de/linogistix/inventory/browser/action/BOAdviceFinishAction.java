...
public final class BOAdviceFinishAction extends NodeAction {

    private static final Logger log = Logger.getLogger(BOAdviceFinishAction.class.getName());
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        NotifyDescriptor d = new NotifyDescriptor.Confirmation(
                NbBundle.getMessage(InventoryBundleResolver.class, "NotifyDescriptor.ReallyFinishAdvice"),

 ...
 * @author krane
 */
public final class BOPickingOrderReleaseAction extends NodeAction {
    ...
    public String getName() {
        return NbBundle.getMessage(InventoryBundleResolver.class, "releaseHalt");
    }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        NotifyDescriptor d = new NotifyDescriptor.Confirmation(
                NbBundle.getMessage(InventoryBundleResolver.class, "NotifyDescriptor.Release.text"),
                NbBundle.getMessage(InventoryBundleResolver.class, "NotifyDescriptor.Release.title"),
        ...
        try {
            ...
            for (Node n : activatedNodes) {
                ...
                if( order.getState()>State.RAW ) {
                    pickingFacade.haltOrder(order.getId());
                }
                else {
                    pickingFacade.releaseOrder(order.getId());
                }
            }
        } catch (Exception ex) {

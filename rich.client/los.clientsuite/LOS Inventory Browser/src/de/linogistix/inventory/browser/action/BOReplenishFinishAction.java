 ...
 * @author krane
 */
public final class BOReplenishFinishAction extends NodeAction {
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        try {
            ...
            LOSReplenishFacade orderFacade = loc.getStateless(LOSReplenishFacade.class);
            ...
            for (Node n : activatedNodes) {
                ...
                orderFacade.finishOrder(order.getNumber());
            }

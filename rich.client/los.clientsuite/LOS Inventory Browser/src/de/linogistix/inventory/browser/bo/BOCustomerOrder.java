...
import de.linogistix.inventory.browser.masternode.BOCustomerOrderMasterNode;
 ...
 * @author krane
 */
public class BOCustomerOrder extends BO {
    @Override
    ...
    protected BusinessObjectQueryRemote initQueryService() {
        ...
        try {
            ...
            ret = loc.getStateless(LOSCustomerOrderQueryRemote.class);
    ...
    protected BusinessObjectCRUDRemote initCRUDService() {
        ...
        try {
            J2EEServiceLocator loc = (J2EEServiceLocator) Lookup.getDefault().lookup(J2EEServiceLocator.class);
            ret = loc.getStateless(LOSCustomerOrderCRUDRemote.class);
    ...
    protected Property[] initBoMasterNodeProperties() {
        return BOCustomerOrderMasterNode.boMasterNodeProperties();
    }

    @Override
    protected Class<? extends Node> initBoMasterNodeType() {
        return BOCustomerOrderMasterNode.class;
    }
    @Override

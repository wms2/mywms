 ...
 * @author krane
 */
public final class BOUnitLoadGoodsOutAction extends NodeAction {
    ...
    protected boolean enable(Node[] activatedNodes) {
        ...
        try {
            for (Node n : activatedNodes) {
                ...
                UnitLoadTO unitLoad = (UnitLoadTO)((BOMasterNode)n).getEntity();
            }
        } catch (Exception e) {
            return false;
        }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        try {
            ...
            for (Node n : activatedNodes) {
                ...
                node = (BOMasterNode)n;
                UnitLoadTO unitLoad = (UnitLoadTO)node.getEntity();

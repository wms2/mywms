 ...
 * @author krane
 */
public final class BOGoodsOutPositionCancelAction extends NodeAction {

    private static final Logger log = Logger.getLogger(BOGoodsOutPositionCancelAction.class.getName());
   private static String[] allowedRoles = new String[]{
        Role.ADMIN.toString(),Role.INVENTORY_STR,Role.FOREMAN_STR
   };

    public String getName() {
        return NbBundle.getMessage(InventoryBundleResolver.class, "cancel");
    }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        NotifyDescriptor d = new NotifyDescriptor.Confirmation(
                NbBundle.getMessage(InventoryBundleResolver.class, "NotifyDescriptor.ReallyCancelLines"),
        ...
        try {
            ...
            for (Node n : activatedNodes) {
                ...
                l.add(((BOMasterNode)n).getEntity().getId());
            }

...
import de.linogistix.inventory.browser.masternode.BOCustomerOrderPositionMasterNode;
 ...
 * @author krane
 */
public class BOCustomerOrderPosition extends BO {
    @Override
  ...
  protected BusinessObjectQueryRemote initQueryService() {
    ...
    try{
      ...
      ret = loc.getStateless(LOSCustomerOrderPositionQueryRemote.class);
  ...
  protected BusinessObjectCRUDRemote initCRUDService(){
    ...
    try{
      J2EEServiceLocator loc = (J2EEServiceLocator)Lookup.getDefault().lookup(J2EEServiceLocator.class);
      ret = loc.getStateless(LOSCustomerOrderPositionCRUDRemote.class);
  ...
  protected String[] initIdentifiableProperties() {
    ...
    protected Property[] initBoMasterNodeProperties() {
        return BOCustomerOrderPositionMasterNode.boMasterNodeProperties();
    }

    @Override
    protected Class<? extends Node> initBoMasterNodeType() {
        return BOCustomerOrderPositionMasterNode.class;
    }

...
public final class BOGoodsOutFinishAction extends NodeAction {

    private static final Logger log = Logger.getLogger(BOGoodsOutFinishAction.class.getName());
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        try {
            ...
            for (Node n : activatedNodes) {
                ...
                m.finishOrder(((BOMasterNode)n).getEntity().getId());
            }

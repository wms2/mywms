...
public final class StocktakingRecountAction extends NodeAction {
    ...
    public String getName() {
        return NbBundle.getMessage(StocktakingBundleResolver.class, "recount");
    }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        NotifyDescriptor d = new NotifyDescriptor.Confirmation(
                NbBundle.getMessage(StocktakingBundleResolver.class, "ReallyProcessRecount"),
        ...
        try {
            ...
            for (Node n : activatedNodes) {
                ...
                m.recountOrder( ((BOMasterNode)n).getEntity().getId() );

 ...
 */
final public class ImportItemDataHintPanel implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private static final Logger log = Logger.getLogger(ImportItemDataHintPanel.class.getName());
    
    private ImportItemDataWizard wizard;
    ...
    public void readSettings(Object settings) {
        try {
            this.wizard = (ImportItemDataWizard) settings;

            int noe = wizard.getNumberOfEntries();
            String filename = this.wizard.getFile().getCanonicalPath();
            StringBuffer b = new StringBuffer();
            b.append(NbBundle.getMessage(BundleResolver.class, "ImportItemDataHintPanel.importhint", new Object[]{noe, filename}));
    ...
    class ImportTask extends org.jdesktop.swingx.util.SwingWorker<Void, Void> {
        ...
        protected Void doInBackground() throws Exception {
            try {
                ...
                List<Object> list = importDataService.importData(ItemData.class.getSimpleName(), data);
                wizard.setImportedItemData(list);

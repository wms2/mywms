...
import de.linogistix.common.bobrowser.bo.detailview.BOCommentDetailEditPanel;
 ...
 */
final public class BOAdditionalContentPanel1 implements WizardDescriptor.FinishablePanel{
  
  private BOAdditionalContentWizard wizard;
  
  private BOCommentDetailEditPanel  ui;
  ...
  private BOCommentDetailEditPanel getPanelUI() {
    if (ui == null) {
        ui = new BOCommentDetailEditPanel();
        ui.getCommentArea().addKeyListener(new java.awt.event.KeyAdapter() {
  ...
  public boolean isValid() {
    if (ui == null)
      return false;
    if (ui.getComment() != null && ui.getComment().length() > 0){
      return true;
    } else{
  ...
  public void readSettings(Object settings) {
    this.wizard = (BOAdditionalContentWizard)settings;
    getPanelUI().setComment(wizard.getComment());
  }
  ...
  public void storeSettings(Object settings) {
    this.wizard = (BOAdditionalContentWizard)settings;
    wizard.setComment(getPanelUI().getComment());

 ...
 */
final public class StockUnitTransferInfoPage implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private StockUnitTransferWizard wizard;
    private StockUnitTransferInfoPanel ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;

    public StockUnitTransferInfoPage() {
        ui = new StockUnitTransferInfoPanel();
    }
//    private Panel getPanelUI() {
//        if (ui == null) {
//            ui = new AbstractSUTransferInfoPanel();
//        }
//        return ui;
//    }
...
//        }
    ...
    public void readSettings(Object settings) {
        ...
        if (wizard.getInfo() != null) ui.setInfo(wizard.getInfo());

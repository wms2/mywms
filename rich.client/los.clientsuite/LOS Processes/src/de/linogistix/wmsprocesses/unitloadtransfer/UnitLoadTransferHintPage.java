 ...
 */
final public class UnitLoadTransferHintPage implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private UnitLoadTransferWizard wizard;
    private UnitLoadTransferHintPanel ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;
            
    private UnitLoadTransferHintPanel getPanelUI() {
        if (ui == null) {
            ui = new UnitLoadTransferHintPanel();
        }
        return ui;
    }

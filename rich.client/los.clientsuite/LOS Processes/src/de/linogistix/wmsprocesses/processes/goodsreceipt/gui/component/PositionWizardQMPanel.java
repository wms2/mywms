 ...
 */
final public class PositionWizardQMPanel implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private PositionWizard wizard;
    private PositionWizardQMPanelUI ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;

    private PositionWizardQMPanelUI getPanelUI() {
        if (ui == null) {
            ui = new PositionWizardQMPanelUI();
        }
        return ui;
    }
...
//        }
    ...
    public void readSettings(Object settings) {
        ...
        getPanelUI().initValues(wizard.model.lock, wizard.model.info);
    }
    ...
    public void storeSettings(Object settings) {
        ...
        wizard.model.info = getPanelUI().getTextArea().getText();    
        BOLockEntry l = (BOLockEntry) getPanelUI().getLockComboBox().getSelectedItem();
        wizard.model.lock = l.getBOLock().getLock();
    }

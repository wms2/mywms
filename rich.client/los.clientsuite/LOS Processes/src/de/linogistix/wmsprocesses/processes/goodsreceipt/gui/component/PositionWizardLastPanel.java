 ...
 */
final public class PositionWizardLastPanel implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private PositionWizard wizard;
    private PositionWizardLastPanelUI ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;

    private PositionWizardLastPanelUI getPanelUI() {
        if (ui == null) {
            ui = new PositionWizardLastPanelUI();
        }
        return ui;
    }
...
//        }
    ...
    public void readSettings(Object settings) {
        ...
        getPanelUI().initFromModel(wizard.model);
    }

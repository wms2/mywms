...
public class Logo extends JPanel implements Constants, MouseListener {
    ...
    public static Logo createLinogistixLogo() {
        return new Logo( LINOGISTIX_LOGO_IMAGE, BundleSupport.getURL( "LinogistixLogo" ) );
    }
    
    public static Logo createMyWmsLogo() {
        return new Logo( MYWMS_LOGO_IMAGE, BundleSupport.getURL( "MyWmsLogo" ) );
    }

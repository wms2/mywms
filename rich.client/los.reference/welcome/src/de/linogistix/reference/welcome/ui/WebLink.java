...
public class WebLink extends LinkButton {
    ...
    public WebLink( String key, Color foreground, boolean showBorder ) {
        this( BundleSupport.getLabel( key ), BundleSupport.getURL( key ), foreground, showBorder);
    }

    public WebLink( String label, String url, Color foreground, boolean showBorder ) {
        super( label, foreground, showBorder, 0.0f);
        this.url = url;
    }
    
     public WebLink( String key, Color foreground, float fontSize) {
        this( BundleSupport.getLabel( key ), BundleSupport.getURL( key ), foreground, fontSize );
    }
    
    public WebLink( String label, String url, Color foreground, float fontSize) {
        super( label, foreground, false, fontSize );
        this.url = url;
    }

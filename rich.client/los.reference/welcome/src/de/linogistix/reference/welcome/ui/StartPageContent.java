...
import de.linogistix.reference.welcome.content.DocumentationTab;
import de.linogistix.reference.welcome.content.ContactTab;
...
public class StartPageContent extends JPanel implements Constants {
    ...
    private final static Color COLOR_TOP_START = new Color(100, 100, 100);
    ...
    private final static Color COLOR_BOTTOM_END = new Color(200, 200, 200);

    public StartPageContent() {
        super( new GridBagLayout() );

        JComponent tabs = new TabbedPane( 
                new DocumentationTab(),
                new ContactTab());

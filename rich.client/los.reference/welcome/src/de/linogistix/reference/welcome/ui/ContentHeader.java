...
public class ContentHeader extends JPanel implements Constants {
    ...
    static {
        String imgName =IMAGE_CONTENT_BANNER;
        IMG_BANNER = ImageUtilities.loadImage(imgName, true);
        Color c = new Color( 110, 110, 110 );
        COL_BANNER_LEFT = c;
        c = new Color( 252, 252, 252 );
        COL_BANNER_RIGHT = c;
    };

    private final JLabel lblTitle = new JLabel();
    
    private final Color COL_GRADIENT_START = new Color( 255, 255, 255);
    private final Color COL_GRADIENT_END = new Color( 230, 230, 230 );
    ...
    protected void paintComponent( Graphics g ) {
        ...
        if( imgX > 0 ) {
            ...
            g2d.fillRect( width-imgX-1, 13, imgX, height-13 );
        }
    }
}

...
public class BottomBar extends JPanel {
    ...
    public BottomBar() {
        ...
        add( Logo.createLinogistixLogo(), new GridBagConstraints(0,0,1,1,0.0,0.0,
                GridBagConstraints.WEST,GridBagConstraints.NONE,new Insets(12,12,5,5),0,0 ) );
        
        // placeholder; other logos, etc. may be placed instead here
        add( new JLabel(), new GridBagConstraints(1,0,1,1,1.0,0.0,
                GridBagConstraints.CENTER,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0 ) );
        
        // placeholder; other logos, etc. may be placed instead here
        add( new JLabel(), new GridBagConstraints(4,0,1,1,0.0,0.0,

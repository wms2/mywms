...
import de.linogistix.reference.welcome.WelcomeOptions;
...
//                    setSelected( !isSelected );
    ...
    private class TabHeader extends JPanel {
        ...
        public TabHeader( TabButton ... buttons ) {
            ...
            add( Logo.createMyWmsLogo(), new GridBagConstraints( 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,12,5,12), 0, 0) );
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2d.drawLine(getWidth()-1, getHeight()-1, getWidth()-1, 0);
            g2d.drawLine(getWidth()-1, 0, 0, 0);            
        }

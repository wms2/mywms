...
public class ButtonBorder implements Border {
    ...
    private ButtonBorder( boolean mouseOver ) {
        if( mouseOver ) {
            imgLeft = ImageUtilities.loadImage("de/linogistix/reference/welcome/resources/sel_btn_left.png");
            imgRight = ImageUtilities.loadImage("de/linogistix/reference/welcome/resources/sel_btn_right.png");
            imgCenter = ImageUtilities.loadImage("de/linogistix/reference/welcome/resources/sel_btn_center.png");
        } else {
            imgLeft = ImageUtilities.loadImage("de/linogistix/reference/welcome/resources/btn_left.png");
            imgRight = ImageUtilities.loadImage("de/linogistix/reference/welcome/resources/btn_right.png");
            imgCenter = ImageUtilities.loadImage("de/linogistix/reference/welcome/resources/btn_center.png");
        }
    }

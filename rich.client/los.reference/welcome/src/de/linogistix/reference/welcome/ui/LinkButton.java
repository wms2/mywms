...
public abstract class LinkButton extends JButton
    ...
    public LinkButton( String label, boolean showBorder) {
        this( label, Utils.getLinkColor(), showBorder);
    }
    ...
    public LinkButton( String label, Color foreground, boolean showBorder) {
        this (label, foreground, showBorder, 0.0f);
    }
    public LinkButton( String label, Color foreground, float fontSize) {
        this( label, foreground, false, fontSize);
    }
    
    public LinkButton( String label, Color foreground, boolean showBorder, float fontSize) {
        super( label );
        ...
        if (fontSize <= 0.0) {
          ...
          setFont( BUTTON_FONT.deriveFont(fontSize) );  
        }

 ...
 * @author krane
 */
public class CreateDemoTopologyAction extends AbstractAction {
     
    public String[] getAllowedRoles() {
        return new String[] {Role.ADMIN_STR};
    }
    
    public CreateDemoTopologyAction() {
        super(NbBundle.getMessage(ReferenceBundleResolver.class, "createDemoTopology"));
        ...
        try {
            ...
            if (DialogDisplayer.getDefault().notify(d) == NotifyDescriptor.OK_OPTION) {
                ...
                d = new NotifyDescriptor.Message(
                    NbBundle.getMessage(ReferenceBundleResolver.class, "createDemoTopology.finish"),

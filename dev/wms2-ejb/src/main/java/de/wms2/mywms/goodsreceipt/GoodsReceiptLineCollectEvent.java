...
/**
 * This event fired when a goods receipt line is created (collected)
 * 
 * @author krane
 *
 */
public class GoodsReceiptLineCollectEvent {
	private GoodsReceiptLine goodsReceiptLine;

	public GoodsReceiptLineCollectEvent(GoodsReceiptLine goodsReceiptLine) {

...
public class Wms2Properties {
	...
	public static final String KEY_STORAGESTRATEGY_DEFAULT = "STRATEGY_STORAGE_DEFAULT";
	public static final String KEY_STORAGESTRATEGY_REPLENISHMENT = "STRATEGY_STORAGE_REPLENISHMENT";
